  ...
  "def": {
    ...
    "playerName": {
      ...
      "textFormat": {
        ...
        "size": 13,                   //   размер
        "color": "{{c:rating}}",                //   цвет (допускается использование динамического цвета, см. macros.txt)
      ...
      "format": "{{nick}}: {{rating%2d~%}} ({{kb%2d~k}})"            //   формат текста. См. описание макросов в macros.txt
    },
